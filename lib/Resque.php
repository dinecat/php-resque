...
class Resque
{
    ...
    /**
     * Password for authenticating with redis server (if server require authentication).
     * @var string|null
     */
     ...
     * @param int $database
     * @param   string  $password   Password for authenticating with redis server [optional]
     */
